...
let displayButton = document.querySelector("button");
    displayButton.addEventListener('click', function() {
        if (displayButton.textContent === 'English'){
            ...
            document.location.href="article2English.html"; 
        }else {
            displayButton.textContent === 'Français';
            displayButton.textContent = 'English';
            document.location.href="article2.html"; 
        }
    });
...
function carrousel2(){
    ...
    imgs2.style.transform = `translateX(${-j *300}px)`;
}
...
function carrousel3(){
    ...
    imgs3.style.transform = `translateX(${-k *500}px)`;
}
